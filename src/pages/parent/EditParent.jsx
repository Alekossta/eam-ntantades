        ...
        const getUser = async () => 
        {
            try 
            {
                ...
                if (parentDoc.exists()) {
                    ...
                    setValue("voucher", data.paymentInfo.voucher);
                    setValue("cardNumber", data.paymentInfo.cardNumber);
                    setValue("cvv", data.paymentInfo.cardCvv);
                    
                    const milliseconds2 = data.paymentInfo.expirationDate.seconds * 1000;
                    // Create a Day.js object
                    const dayjsObject2 = dayjs(milliseconds2);
                    setValue("expirationDate", dayjsObject2);
                    return data;
                } else {
